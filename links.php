    ...
    <div>
      ...
      <header>
        <h1 class="header first-letter">
          <span class="first-letter">リンク</span> (Links)
        </h1>
      </header>
      ...
      <div id="nestedAccordion">
        ...
        <div>
          <ul class="content">
            ...
            <li>関西弁の自主学習サイト : Kansai Dialect: Self-study site for Japanese Language Learners</li>
            <li>京言葉 (Kyoo Kotoba) The Language of Kyoko: site translated by Tan Nguyen (UT Austin)</li>
            <li>BROVISION.COM; Video clips about life in Japan (Plugins required. RealPlayer has better quality than WinPlayer)</li>
            <li>Foreign Press Center Japan</li>
            <li>What You Need To Know About Japan; Subject (e.g. Anime, Manga, Culture) links are listed on the left side of the screen</li>
            <li>Japanese Holidays; An ordered list of holidays in Japanese and English, with descriptions in Japanese.</li>
            <li>Jeff Blum's Yookoso; A great assemblage of pages and links about all things Japanese, including study notes, culture, language, travel, anime, music, and more.</li>
            <li>Yahoo! Japan: "kids", etc.</li>
            <li>Japanese Traditional Music</li>
            <li>石川で学ぶ - cultural situations for study abroad students. You can watch sample video clips (bottom of the page)</li>
            <li>Japanese Culture: The Visual Arts</li>
          </ul>
        </div>
        ...
        <div>
          <ul class="content">
            ...
            <li>CNN Japan</li>
            <li>Asahi Shimbun</li>
            <li>Yomiuri Shimbun</li>
            <li>Yomiuri Online (Video News)</li>
            <li>NTV News</li>
            <li>NNN News</li>
            <li>FNN News</li>
            <li>JNN News</li>
            <li>TBS News: audio and written form at the same time</li>
            <li>Japan Brief: Japanese and English (a handy report which gives up-to-the-minute background</li>
            <li>information reflected in the editorials of major Japanese newspapers)</li>
            <li>Japanese Radio</li>
            <li>E-Radio: Talk shows (requires RealPlayer or Windows Media Player)</li>
            <li>Japan-A-Radio - Japanese music</li>
          </ul>
        </div>
